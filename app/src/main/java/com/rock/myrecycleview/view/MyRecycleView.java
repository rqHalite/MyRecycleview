...
import com.rock.myrecycleview.adapter.WrapperAdapter;
import com.rock.myrecycleview.listener.OnLoadMoreListener;
import com.rock.myrecycleview.listener.OnLoadMoreScrollListener;
import com.rock.myrecycleview.listener.OnRefreshListener;
import com.rock.myrecycleview.listener.SimpleAnimatorListener;
...
public class MyRecycleView  extends RecyclerView {
    private static final String TAG = MyRecycleView.class.getSimpleName();
    ...
    public MyRecycleView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MyRecycleView, defStyle, 0);
        ...
        try {
            refreshEnabled = a.getBoolean(R.styleable.MyRecycleView_refreshEnabled, false);
            loadMoreEnabled = a.getBoolean(R.styleable.MyRecycleView_loadMoreEnabled, false);
            refreshHeaderLayoutRes = a.getResourceId(R.styleable.MyRecycleView_refreshHeaderLayout, -1);
            loadMoreFooterLayoutRes = a.getResourceId(R.styleable.MyRecycleView_loadMoreFooterLayout, -1);
            refreshFinalMoveOffset = a.getDimensionPixelOffset(R.styleable.MyRecycleView_refreshFinalMoveOffset, -1);
